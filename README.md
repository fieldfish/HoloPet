...
![HoloPet 紧凑底座 V4 装配预览](mechanical/compact_base_v4/preview/assembly_with_components.png)
...
- 紧凑机械设计 V4：142 mm 主体外径，包含圆屏、Pi 5、双扬声器、70 mm 麦克风/音频组件及两端各 10 mm 弯折余量、贯通旋钮孔和玻璃罩收口。
...
本仓库坚持区分“代码通过”“实机通过”和“机械实物通过”。机械尺寸与打印边界见 [机械设计说明](mechanical/compact_base_v4/README.md)；V3/V3.1 已被实物否决，禁止继续送印。
...
tests/                       C++ 与协议测试
mechanical/compact_base_v4/  当前纠错候选与配合测试件（V3/V3.1 禁止送印）
docs/                        架构、界面、硬件与隐私说明
```
...
打印文件位于 `mechanical/compact_base_v4/stl/`。必须先打印 `fit_test/screen_body_fit_coupon.stl` 和 `fit_test/speaker_fit_coupon.stl`；两项实物通过后才能打印整套结构件。
